...
(define z (list aa na boom get job sha yip wah))
(define sample '(get a job 
...
(define (test)
  (testing (list a b c d 
                 ...
                 (generate-huffman-tree z)
                 (encode sample (generate-huffman-tree z))
                 (length (encode sample (generate-huffman-tree z)))
                 )
           ) 
  )
