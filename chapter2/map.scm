...
(define (reverse-with-fold-right seqs)
  (fold-right (lambda (x y)
                (append y (list x)) 
                ) nil seqs)
  )
(define (reverse-with-fold-left seqs)
...
(define (remove item seqs)
  (filter (lambda (x) (not (= x item))) seqs)
  )
...
(define (test)
  ...
  (testing (list (fold-right / 1.0 (list 1 2 3))
                 (fold-left / 1.0 (list 1 2 3))
                 (fold-right list nil (list 1 2 3))
                 (fold-left list nil (list 1 2 3))
                 (fold-right + 0 (list 1 2 3))
                 (fold-left + 0 (list 1 2 3))
                 (reverse-with-fold-right (list 1 2 3 4))
                 (reverse-with-fold-left (list 1 2 3 4))
                 (prime-sum-pairs 10)
                 (permutations (list 1 2 3))
                 (unique-pairs 10)
                 (ordered-triples-sum 10 6)
                 (ordered-triples-sum 10 7)
                 (ordered-triples-sum 10 8)
                 (ordered-triples-sum 10 9)
                 (ordered-triples-sum 10 10)
                 )
           )  
  )
